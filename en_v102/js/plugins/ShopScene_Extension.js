...
class Sprite_ActorCharacter extends Sprite_Clickable {
    ...
    updateBitmap(enabled, equipState) {
        ...
        case "cannot":
            ...
            this.bitmap.drawText("×", 0, 0, 16, 16);
            break;
        case "equipped":
            this.bitmap.fontSize = 20;
            this.bitmap.textColor = "#ffffff";
            this.bitmap.drawText("Ｅ", 0, 0, 16, 16);
            break;
        case "up":
            this.drawUpTriangle(0, 0, 16, 16, "#000000", "#00ff00");
            break;
        case "down":
            this.drawDownTriangle(0, 0, 16, 16, "#000000", "#ff6666");
            break;
        }
        return true;
    }
...
Window_ShopStatus.prototype.drawItem = function(x, y, paramId) {
    ...
    if (this._actor) this.drawCurrentParam(paramX - 104, y, paramId);
    this.drawRightArrow(paramX + paramWidth - 26, y);
    this.drawNewParam(paramX + paramWidth + rightArrowWidth - 52, y, paramId);
};
...
Window_ShopStatus.prototype.drawCurrentParam = function(x, y, paramId) {
    const paramWidth = this.paramWidth();
    this.resetTextColor();
    this.drawText(this._actor.param(paramId), x, y, paramWidth + 52, "right");
};
...
Window_ShopStatus.prototype.drawNewParam = function(x, y, paramId) {
    ...
    if (this._actor.canEquip(this._item)) {
        ...
        this.drawText(newValue, x, y, paramWidth + 52, "right");
    } else {
        this.resetTextColor();
